...
const { helloWorld, searchUSer, NewUser, update, newNeed, options, newInvestment, activeLoan, loanStatus, myInvestments, payment } = require('./gets')
...
router.post('/app/api/v1/pagar', payment);
